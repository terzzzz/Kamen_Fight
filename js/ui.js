...
function playSelectionBGM() {
  ...
  selectionBGM.play().catch(err => {
    console.log("Waiting for user interaction to play selection music...", err);
  });
}
...
function playBattleBGM() {
  ...
  battleBGM.play().catch(err => {
    console.log("Waiting for user interaction to play battle music...", err);
  });
}
...
// Character Selection Screen State (P1 & P2 Default to Ichigo - Index 0)
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Global click & key listeners to unlock HTML5 browser audio
  const unlockAudio = () => {
    playSelectionBGM();
